...
| ---------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| art_position_memory_enabled        | automatically re-position the art using the position values from a csv file (created by using the option below); this 'memory' is linked to the art filename, so if you change that then you must either re-position it or update the filename in the csv to match | false   | auto = true                                                                                                                                                                                                         | none                                                                                                                                                                                                  |
