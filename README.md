...
| use_1993_frame (ancient template)                    | use the 1993 version of the classic frame instead of the default 1997 version                                                                                        | auto    | cards from any pre-Mirage sets will be rendered using the 1993 frame assets                                                                                                                                           | [inter-1993 nuances are missing](https://github.com/HelixVita/FelixVita-Proxyshop-Plugins/issues/8); [missing land and gold frame](https://github.com/HelixVita/FelixVita-Proxyshop-Plugins/issues/9) |
