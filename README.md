...
| art_position_memorize_new          | pauses the proxyshop rendering process to let you manually adjust the art position in photoshop; when you click "Continue" this position will be saved in a CSV file | auto    | auto = true if no position is saved yet, else false                                                                                                                                                                 | none                                                                                                                                                                                                  |
